...
function cs_wc_extra_register_fields() {
	...
	<p class="form-row form-row-first">
		<label for="reg_billing_first_name"><?php _e( 'Name', 'textdomain' ); ?> <span class="required">*</span></label>
...
function cs_wc_validate_extra_register_fields( $username, $email, $validation_errors ) {
	if ( isset( $_POST['billing_first_name'] ) && empty( $_POST['billing_first_name'] ) ) {
		$validation_errors->add( 'billing_first_name_error', __( '<strong>Erro</strong>: Type your name.', 'textdomain' ) );
	}

	if ( isset( $_POST['billing_last_name'] ) && empty( $_POST['billing_last_name'] ) ) {
		$validation_errors->add( 'billing_last_name_error', __( '<strong>Erro</strong>: Type your name.', 'textdomain' ) );
	}
}
